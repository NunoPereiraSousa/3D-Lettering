...
import {
    TransformControls
} from "../../node_modules/three/examples/jsm/controls/TransformControls.js";
import {
    InstancedFlow
} from "../../node_modules/three/examples/jsm/modifiers/CurveModifier.js";
...
function init() {
    ...
    const boxMaterial = new THREE.MeshBasicMaterial(0x0F658D);
    ...
    const light = new THREE.DirectionalLight(0xF09A72);
    ...
    loader.load("../../node_modules/three/examples/fonts/helvetiker_regular.typeface.json", function (
        font
    ) {
        ...
        for (let i = 0; i < numberOfInstances; i++) {
            ...
            flow.object3D.setColorAt(i, new THREE.Color(0x0F658D));
